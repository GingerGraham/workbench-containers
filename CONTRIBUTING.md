# Contributing to workbench-containers

This is a `workbench` ecosystem module — it doesn't stand alone. It's
installed into a machine via `workbench-core`'s `wb add containers`. Full
...
```sh
git clone https://github.com/GingerGraham/workbench-containers.git
cd workbench-containers
...
wb dev containers
# — or directly:
wb track containers --branch <your-branch>
```
